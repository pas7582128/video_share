...
<body>
            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-lg-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <center><h4 class="header-title">Videos</h4></center>
                                        ...
                                        <table class="table table-hover text-center">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="delete_data.php?video_id=<?php echo $row['id']; ?>" style="font-size: 20px;"><i class="ti-trash"></i></a></td>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('.metismenu li:nth-child(5)').addClass('active');
