                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Unapproved Videos</h4>
            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-lg-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <center><h4 class="header-title">Unapproved Videos</h4></center>
                                <div class="single-table">
                                    <div class="table-responsive">
                                        <table class="table table-hover text-center">
                                            ...
                                            <tbody>
                                                <?php
                                                    $select=mysqli_query($con,"SELECT * FROM video WHERE `approved`=0");
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="give_approve.php?video_id=<?php echo $row['id'];?>">Approve</a>
                                                    </td>
                                                    <td><a href="delete_data.php?video_id_unapproved=<?php echo $row['id']; ?>" style="font-size: 20px;"><i class="ti-trash"></i></a></td>
                                                    <!-- <td><a href="update_video.php?id=<?php echo $row['id']; ?>">Update</a></td> -->
                                                </tr>
                                                <?php } ?>
                                            </tbody>
                                        </table>
