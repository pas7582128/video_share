            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-lg-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <center><h4 class="header-title">USERS</h4></center>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php 
                                                        if($row['status']==0){
                                                    ?>
                                                    <td><a href="approve_user.php?id=<?php echo $row['id']; ?>">Approve</a></td>
                                                    <?php
                                                        }else{
                                                    ?>
                                                        <td><a href="block_user.php?id=<?php echo $row['id']; ?>">Block</a></td>
                                                    <?php
                                                        }
                                                    ?>
                                                    <td><a href="delete_data.php?user_id=<?php echo $row['id']; ?>" style="font-size: 20px;"><i class="ti-trash"></i></a></td>
